...
public class CreateRetentionPolicyPage {

	public WebDriver driver;
	public CreateRetentionPolicyPage(WebDriver localdriver) {
	...
	public void Fill_NewRetentionPolicyForm(CharSequence policyName,CharSequence description,String option){
