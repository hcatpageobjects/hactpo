...
import com.hpe.digitalsafe.Pages.DSDiscoveryModule.ClickOnCasePage;
import com.hpe.digitalsafe.Pages.DSDiscoveryModule.DSD_Tabs;

public class DSD_ClickCaseTests {

	protected WebDriver driver;
	protected HomePage home_page;
	protected DSD_Tabs DSD_Tab;

	protected ClickOnCasePage click_case;
	@BeforeSuite
	...
	@BeforeMethod
	 public void setUp() {
		 driver=BrowserFactory.startBrowserDefault();
			...
			click_case=PageFactory.initElements(driver, ClickOnCasePage.class);
